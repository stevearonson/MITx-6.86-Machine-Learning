...
print('Linear Regression lambda sweep:')
...
plot_cost_function_over_time(cost_function_history)
pca_cube_test_error = compute_test_error(test_cube, test_y, theta, temp_parameter)

print('PCA CUBIC test_error=', pca_cube_test_error)
